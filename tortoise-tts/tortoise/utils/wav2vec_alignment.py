...
class Wav2VecAlignment:
    ...
    def __init__(self):
        """
        self.model = Wav2Vec2ForCTC.from_pretrained("/content/drive/MyDrive/Colab Notebooks/Voice Cloner/wav2vec2-large-robust-ft-libritts-voxpopuli").cpu()
        self.feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained(f"/content/drive/MyDrive/Colab Notebooks/Voice Cloner/wav2vec2-large-960h")
        self.tokenizer = Wav2Vec2CTCTokenizer.from_pretrained('/content/drive/MyDrive/Colab Notebooks/Voice Cloner/tacotron-symbols')
        """
        #self.model = Wav2Vec2ForCTC.from_pretrained("https://huggingface.co/mehulofficial14/Voice-Cloner/tree/main/wav2vec2-large-robust-ft-libritts-voxpopuli").cpu()
        self.model = Wav2Vec2ForCTC.from_pretrained("/content/drive/MyDrive/Colab Notebooks/Voice Cloner/wav2vec2-large-robust-ft-libritts-voxpopuli").cpu()
        #self.feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained("https://huggingface.co/mehulofficial14/Voice-Cloner/tree/main/wav2vec2-large-960h")
        self.feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained(f"/content/drive/MyDrive/Colab Notebooks/Voice Cloner/wav2vec2-large-960h")
        #self.tokenizer = Wav2Vec2CTCTokenizer.from_pretrained("https://huggingface.co/mehulofficial14/Voice-Cloner/tree/main/tacotron-symbols")
        self.tokenizer = Wav2Vec2CTCTokenizer.from_pretrained('/content/drive/MyDrive/Colab Notebooks/Voice Cloner/tacotron-symbols')
