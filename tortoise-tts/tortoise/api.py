...
def download_models(specific_models=None):
    ...
    """
    MODELS = {
        'autoregressive.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/autoregressive.pth',
        'classifier.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/classifier.pth',
        'clvp2.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/clvp2.pth',
        'cvvp.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/cvvp.pth',
        'diffusion_decoder.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/diffusion_decoder.pth',
        'vocoder.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/vocoder.pth',
        'rlg_auto.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/rlg_auto.pth',
        'rlg_diffuser.pth': 'https://huggingface.co/mehulofficial14/Voice-Cloner/blob/main/rlg_diffuser.pth',
    }
